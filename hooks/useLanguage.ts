...
export const STREET_TEXT = {
  // Common Serbian Street/UI terms
  startLesson: 'Kreni! 🔥',
  checkAnswer: 'Proveri ✓',
  backToMap: '← Nazad',
  lessonDone: 'Gotovo!',
  tryAgain: 'Probaj opet 🔄',
  correct: 'Tako je! 🎉',
  wrong: 'Jebiga, nije... 💀',
  loading: 'Učitavanje...',
  yourAnswer: 'Piši ovde...',
  hint: 'Pomoć',
  proContent: 'PRO ⚡',
  completed: '✓ Završeno',
  ...
  next: 'Dalje →',
  finish: 'Završi 🎉',
  lessonNotFound: 'Nema lekcije. 💀',
  xpEarned: 'XP osvojeno',
  mistakesMade: 'Samo {n} greške.',
  chooseAnswer: '🧠 Izaberi',
  translate: '✍️ Prevedi',
  typeHere: 'Piši ovde, brate...',
  startQuiz: '🚀 Kreni na kviz',
} as const;
