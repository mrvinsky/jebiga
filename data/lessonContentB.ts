...
export const lessonContentB: Record<string, LessonContent> = {
  ...
  'slang-1': {
    ...
    vocabulary: [
      ...
      { word: 'Gde si', pronunciation: 'GDE si', translation: 'Naber? / Neredesin? (Selamlaşma)', translationEn: 'What\'s up? / Where are you? (Greeting)', example: 'Gde si, brate? Šta se radi?' },
    ],
    ...
    dialogue: [
      { speaker: 'A', serbian: 'Gde si, brate, šta ima?', translation: 'Naber birader, neler var?', translationEn: 'What\'s up bro, how is it going?' },
  ...
  'slang-2': {
    ...
    vocabulary: [
      ...
      { word: 'Vrh', pronunciation: 'vırh', translation: 'Efsane! / Zirve!', translationEn: 'Peak / Legendary / Awesome!', example: 'Taj gol je bio vrh!' },
      { word: 'Top', pronunciation: 'top', translation: 'On numara! / Harika!', translationEn: 'Top / Excellent / Perfect!', example: 'Kako si? — Top!' },
      { word: 'Opušteno', pronunciation: 'O-puş-te-no', translation: 'Rahat / Sıkıntı yok', translationEn: 'Relax / Chill / No problem', example: 'Opušteno brate, sve je u redu.' },
      ...
      { word: 'Vopi', pronunciation: 'VO-pi', translation: 'Bira (Pivo kelimesinin argosu)', translationEn: 'Beer (Slang for Pivo)', example: 'Ajde na vopi!' },
      { word: 'Gajba', pronunciation: 'GAY-ba', translation: 'Ev / Daire (Harfiyen: Kasa)', translationEn: 'House / Apartment (Literal: Crate)', example: 'Idemo kod mene na gajbu.' },
    ],
    grammarNote: {
    ...
    culturalTip: 'Sırplar "Vrh" veya "Top" kelimesini bizdeki "ateş ediyor" gibi kullanır. Harfiyen zirve demek olsa da asıl anlamı Efsane ve Zirvedir. Çok Balkan işi bir kafadır!',
    culturalTipEn: "Serbians use 'Vrh' or 'Top' like we use 'fire' or 'dope'. Although it literally means 'peak', its slang meaning is 'Legendary' or 'Great'. It's a classic Balkan vibe!",
    dialogue: [
      { speaker: 'A', serbian: 'Šta ima, bre, je l\' sve top?', translation: 'Naber lan her şey yolunda mı?', translationEn: 'What\'s up man, is everything top?' },
      ...
      { speaker: 'A', serbian: 'Opušteno, brate. Idemo na kafu?', translation: 'Rahat ol kanka. Kahveye gidek mi?', translationEn: 'Relax, bro. Shall we go for coffee?' },
      { speaker: 'B', serbian: 'Vrh ideja! Ajde!', translation: 'Efsane fikir! Haydi.', translationEn: 'Great idea! Let\'s go!' },
    ],
  },
  ...
  'slang-3': {
    ...
    vocabulary: [
      ...
      { word: 'Sranje', pronunciation: 'SRA-nye', translation: 'Boktan / Saçma sapan', translationEn: 'Shit / Crap', example: 'Ovo je totalno sranje!' },
    ],
  ...
  'family-1': {
    ...
    vocabulary: [
      ...
      { word: 'Keva / Ćale', pronunciation: 'KE-va / ÇA-le', translation: 'Anne / Baba (Argo)', translationEn: 'Mom / Dad (Slang)', example: 'Moja keva najbolje kuva.' },
    ],
