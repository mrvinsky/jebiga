...
export const lessonContent: Record<string, LessonContent> = {
  ...
  'greetings-2': {
    ...
    vocabulary: [
      ...
      { word: 'Vidimo se kasnije', pronunciation: 'Vİ-di-mo se KAS-ni-ye', translation: 'Sonra görüşürüz', translationEn: 'See you later', example: 'Vidimo se kasnije! Ćao!' },
    ...
    grammarNote: {
      title: '"Drago mi je" ve "Ja sam iz..."',
      titleEn: '"Drago mi je" and "I am from..."',
      body: '"Drago mi je" hem "Tanıştığıma memnun oldum" hem de bir haber aldığında "Senin adına sevindim" anlamına gelir. "Ja sam iz..." (Ben ...lıyım) derken ülke/şehir isminin sonu değişir (Genitive). Örneğin: Engleska -> Engleske, Beograd -> Beograda, Berlin -> Berlina.',
      bodyEn: '"Drago mi je" means both "Nice to meet you" and "I am happy for you". When saying "Ja sam iz..." (I am from...), the noun ending changes (Genitive). E.g.: Engleska -> Engleske, Beograd -> Beograda, Berlin -> Berlina.',
    },
    ...
    dialogue: [
      ...
      { speaker: 'A', serbian: 'Dobila sam posao! — B: Drago mi je!', translation: 'İşi aldım! — B: Senin adına sevindim!', translationEn: 'I got the job! — B: I am happy for you!' },
    ],
  },
  ...
  'greetings-3': {
    ...
    vocabulary: [
      ...
      { word: 'Hvala lepo na razumevanju', pronunciation: 'HVA-la LE-po na ra-zu-me-VAN-yu', translation: 'Anlayışınız için çok teşekkürler', translationEn: 'Thank you very much for your understanding', example: 'Hvala lepo na razumevanju!' },
    ...
    culturalTip: '"Izvini" kankalar arasında, "Izvinite" ise resmi ortamlarda veya tanımadığın birine hitap ederken kullanılır. Ayrıca "Hvala lepo" (güzel bir şekilde teşekkürler) sadece "hvala" demekten çok daha samimidir kanka.',
    culturalTipEn: '"Izvini" is for friends, "Izvinite" is formal or for strangers. Also, "Hvala lepo" (thank you nicely) is much more heartfelt than just "hvala".',
    dialogue: [
  ...
  'numbers-1': {
    ...
    grammarNote: {
      ...
      body: '"Jedan" (1) ve "Dva" (2) kelimesinin sonuna geldiği cisme göre cinsiyeti değişiyor kanka. Örneğin "Jedan muškarac" (1 erkek) ama "Jedna žena" (1 kadın). "Jedan čaj" ama "Jedna kafa". Diğer sayılarda bir değişim olmaz.',
      bodyEn: 'The gender of "Jedan" (1) and "Dva" (2) changes depending on the noun. For example, "Jedan muškarac" (1 man) but "Jedna žena" (1 woman). "Jedan čaj" vs "Jedna kafa". Others remain the same.',
    },
  ...
  'numbers-2': {
    ...
    vocabulary: [
      { word: 'Jedanaest – Devetnaest', pronunciation: 'ye-DA-na-est … de-VET-na-est', translation: '11–19', translationEn: '11–19', example: 'Jedanaest sati.' },
      { word: 'Dvadeset', pronunciation: 'DVA-de-set', translation: 'Yirmi (20)', translationEn: 'Twenty (20)', example: 'Dvadeset evra.' },
      { word: 'Trideset / Pedeset', pronunciation: 'TRİ-de-set / PE-de-set', translation: '30 / 50', translationEn: '30 / 50', example: 'Pedeset dinara.' },
      { word: 'Sto', pronunciation: 'sto', translation: 'Yüz (100)', translationEn: 'Hundred (100)', example: 'Sto ljudi.' },
  ...
  'numbers-3': {
    ...
    grammarNote: {
      ...
      body: '"Pola tri" kelimesi harfiyen "üçün yarısı" yani 2:30 demek (üçe çeyrek falan değil). Ayrıca saati söylerken genellikle "Tri sata" (Saat üç) veya "Sada je tri" (Şimdi üç) denir, "Tri su sata" pek kullanılmaz.',
      bodyEn: '"Pola tri" literally means "half of three", which is 2:30. When telling time, usually "Tri sata" (Three hours/o\'clock) or "Sada je tri" (Now it\'s three) is used; "Tri su sata" is rare.',
    },
