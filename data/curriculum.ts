    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'g1-q9', type: 'fill-blank', prompt: '"___ jutro" Türkçede "Günaydın" demektir.', promptEn: '"___ jutro" means "Good morning" in Serbian.', streetPrompt: 'Boşluğu doldur: "___ jutro"', answer: 'Dobro', answerEn: 'Dobro', hint: 'İyi = Dobro', hintEn: 'Good = Dobro' },
          { id: 'g1-q10', type: 'fill-blank', prompt: 'Birine "Nasılsın?" demek için "Kako ___?" diyoruz.', promptEn: 'To ask "How are you?" we say "Kako ___?"', streetPrompt: 'Boşluğu doldur: "Kako ___?"', answer: 'si', answerEn: 'si', hint: 'si = -sin (tekil)', hintEn: 'si = you are (singular)' },
          { id: 'g1-q11', type: 'multiple-choice', prompt: '"Dobro veče" ne anlama gelir?', promptEn: 'What does "Dobro veče" mean?', streetPrompt: 'Akşam selamı nasıl verilir?', answer: 'İyi akşamlar', answerEn: 'Good evening', options: ['Günaydın', 'İyi akşamlar', 'İyi geceler', 'Görüşürüz'], optionsEn: ['Good morning', 'Good evening', 'Good night', 'See you'] },
          { id: 'g1-q12', type: 'translate', prompt: '"Görüşürüz" kelimesini çevir', promptEn: 'Translate "See you later"', streetPrompt: 'Pazi — ayrılırken ne dersin?', answer: 'Doviđenja', hint: 'do-vi-đe-nja', hintEn: 'do-vi-đe-nja' },
          { id: 'g1-q13', type: 'fill-blank', prompt: '"Laku ___" Sırpçada "İyi geceler" demektir.', promptEn: '"Laku ___" means "Good night" in Serbian.', streetPrompt: 'Boşluğu doldur: Laku ___', answer: 'noć', answerEn: 'noć', hint: 'gece = noć', hintEn: 'night = noć' },
          { id: 'g1-q14', type: 'multiple-choice', prompt: 'Resmi "Nasılsınız?" sorusu nasıl sorulur?', promptEn: 'How do you ask "How are you?" formally?', streetPrompt: 'Patrona nasıl sorarsın?', answer: 'Kako ste?', answerEn: 'Kako ste?', options: ['Kako si?', 'Kako ste?', 'Kako je?', 'Kako smo?'], optionsEn: ['Kako si?', 'Kako ste?', 'Kako je?', 'Kako smo?'] },
          { id: 'g1-q15', type: 'fill-blank', prompt: '"Zdravo" Türkçede "___ " anlamına gelir.', promptEn: '"Zdravo" means "___ " in English.', streetPrompt: 'Boşluğu doldur: Zdravo = ?', answer: 'Merhaba', answerEn: 'Hello', hint: 'Temel selamlama', hintEn: 'Basic greeting' },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'g2-q6', type: 'fill-blank', prompt: 'Sırpçada "Benim adım Ali" demek için "___ se Ali" deriz.', promptEn: 'In Serbian, to say "My name is Ali" we say "___ se Ali".', streetPrompt: 'Boşluğu doldur: "___ se Ali"', answer: 'Zovem', answerEn: 'Zovem', hint: 'Zovem se = Ben... olarak anılıyorum', hintEn: 'Zovem se = My name is / I am called' },
          { id: 'g2-q7', type: 'translate', prompt: '"Sırpça biliyor musun?" cümlesini çevir', promptEn: 'Translate "Do you know Serbian?"', streetPrompt: 'Birinin Sırpça bilip bilmediğini nasıl sorarsın?', answer: 'Znaš li srpski?', hint: 'znaš li = biliyor musun', hintEn: 'znaš li = do you know' },
          { id: 'g2-q8', type: 'multiple-choice', prompt: '"Drago mi je" ne anlama gelir?', promptEn: 'What does "Drago mi je" mean?', streetPrompt: 'Biriyle tanışınca ne diyorsun?', answer: 'Tanıştığıma memnun oldum', answerEn: 'Nice to meet you', options: ['Görüşürüz', 'Tanıştığıma memnun oldum', 'Nasılsın?', 'Seni seviyorum'], optionsEn: ['See you', 'Nice to meet you', 'How are you?', 'I love you'] },
          { id: 'g2-q9', type: 'fill-blank', prompt: '"Ben Türkiye\'denim" demek için "Ja sam iz ___" deriz.', promptEn: 'To say "I am from Turkey" we say "Ja sam iz ___".', streetPrompt: 'Boşluğu doldur: Türkiye = ?', answer: 'Turske', answerEn: 'Turske', hint: 'Turska = Türkiye', hintEn: 'Turska = Turkey' },
          { id: 'g2-q10', type: 'multiple-choice', prompt: '"Koliko imaš godina?" sorusunun anlamı nedir?', promptEn: 'What does "Koliko imaš godina?" mean?', streetPrompt: 'Pazi — bu soruyu duydun, ne soruluyor?', answer: 'Kaç yaşındasın?', answerEn: 'How old are you?', options: ['Nereden geliyorsun?', 'Kaç yaşındasın?', 'Adın ne?', 'Ne iş yapıyorsun?'], optionsEn: ['Where are you from?', 'How old are you?', 'What is your name?', 'What do you do?'] },
          { id: 'g2-q11', type: 'translate', prompt: '"Ben 25 yaşındayım" cümlesini çevir', promptEn: 'Translate "I am 25 years old"', streetPrompt: 'Yaşını Sırpçada söyle!', answer: 'Imam dvadeset pet godina', hint: 'imam = var bende, godina = yaş/yıl', hintEn: 'imam = I have, godina = years' },
          { id: 'g2-q12', type: 'fill-blank', prompt: '"Ne iş yapıyorsun?" sorusu Sırpçada "Čime se ___?" şeklindedir.', promptEn: 'The question "What do you do?" in Serbian is "Čime se ___?"', streetPrompt: 'Boşluğu doldur: Čime se ___?', answer: 'baviš', answerEn: 'baviš', hint: 'baviti se = uğraşmak', hintEn: 'baviti se = to deal with / to do for a living' },
          { id: 'g2-q13', type: 'multiple-choice', prompt: '"Ja sam student" ne anlama gelir?', promptEn: 'What does "Ja sam student" mean?', streetPrompt: 'Brate — "Ja sam student" ne diyor?', answer: 'Ben öğrenciyim', answerEn: 'I am a student', options: ['Ben çalışıyorum', 'Ben öğrenciyim', 'Ben doktorum', 'Ben emekliyim'], optionsEn: ['I work', 'I am a student', 'I am a doctor', 'I am retired'] },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'g3-q7', type: 'fill-blank', prompt: 'Teşekkür etmek için "___" deriz.', promptEn: 'To say thank you, we say "___".', streetPrompt: 'Boşluğu doldur: teşekkür = ?', answer: 'Hvala', answerEn: 'Hvala', hint: 'H ile başlar', hintEn: 'Starts with H' },
          { id: 'g3-q8', type: 'fill-blank', prompt: 'Birinin dikkatini çekmek için "___, molim!" diyebilirsin.', promptEn: 'To get someone\'s attention, you can say "___, molim!"', streetPrompt: 'Boşluğu doldur: dikkat çekme kelimesi', answer: 'Izvinite', answerEn: 'Izvinite', hint: 'Affedersiniz / Pardon', hintEn: 'Excuse me / Pardon' },
          { id: 'g3-q9', type: 'multiple-choice', prompt: '"Molim" kelimesi hangi iki anlamda kullanılabilir?', promptEn: 'In which two meanings can "Molim" be used?', streetPrompt: 'Pazi — "Molim" çift anlamlıdır!', answer: 'Lütfen ve Rica ederim', answerEn: 'Please and You are welcome', options: ['Teşekkür ve Özür', 'Lütfen ve Rica ederim', 'Merhaba ve Görüşürüz', 'Evet ve Hayır'], optionsEn: ['Thanks and Sorry', 'Please and You are welcome', 'Hello and Goodbye', 'Yes and No'] },
          { id: 'g3-q10', type: 'translate', prompt: '"Çok teşekkür ederim" cümlesini çevir', promptEn: 'Translate "Thank you very much"', streetPrompt: 'Brate — çok teşekkür etmek istiyorsun!', answer: 'Hvala lepo', hint: 'lepo = güzel/çok', hintEn: 'lepo = nicely/very much' },
          { id: 'g3-q11', type: 'fill-blank', prompt: '"Žao mi ___" Sırpçada "Özür dilerim" anlamına gelir.', promptEn: '"Žao mi ___" means "I am sorry" in Serbian.', streetPrompt: 'Boşluğu doldur: Žao mi ___', answer: 'je', answerEn: 'je', hint: 'je = -dir, 3. tekil şahıs', hintEn: 'je = is (3rd person)' },
          { id: 'g3-q12', type: 'multiple-choice', prompt: '"Slobodno" ne anlama gelir?', promptEn: 'What does "Slobodno" mean?', streetPrompt: '"Slobodno" — šta znači?', answer: 'Buyurun / Serbest', answerEn: 'Feel free / Go ahead', options: ['Yasak', 'Ücretli', 'Buyurun / Serbest', 'Dolu'], optionsEn: ['Forbidden', 'Paid', 'Feel free / Go ahead', 'Full'] },
          { id: 'g3-q13', type: 'fill-blank', prompt: '"Nema ___" Sırpçada "Sorun değil" anlamına gelir.', promptEn: '"Nema ___" means "No problem" in Serbian.', streetPrompt: 'Boşluğu doldur: Nema ___', answer: 'problema', answerEn: 'problema', hint: 'problema = sorunun (tekil genitif)', hintEn: 'problema = of problem' },
          { id: 'g3-q14', type: 'multiple-choice', prompt: 'Birine yardım etmek istediğini nasıl söylersin?', promptEn: 'How do you offer help to someone?', streetPrompt: 'Birini yardım etmek istiyorsun — ne dersin?', answer: 'Mogu li vam pomoći?', answerEn: 'Mogu li vam pomoći?', options: ['Trebam pomoć', 'Mogu li vam pomoći?', 'Ne mogu da pomognem', 'Ne treba mi pomoć'], optionsEn: ['I need help', 'Mogu li vam pomoći?', 'I cannot help', 'I do not need help'] },
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'n1-q8', type: 'fill-blank', prompt: 'Sırpçada "dört" kelimesi "___" dir.', promptEn: 'The word for "four" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 4 = ?', answer: 'Četiri', answerEn: 'Četiri', hint: 'Che-ti-ri', hintEn: 'Che-ti-ri' },
          { id: 'n1-q9', type: 'fill-blank', prompt: 'Sırpçada "altı" kelimesi "___" dir.', promptEn: 'The word for "six" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 6 = ?', answer: 'Šest', answerEn: 'Šest', hint: 'Sh-est', hintEn: 'Sh-est' },
          { id: 'n1-q10', type: 'translate', prompt: '"7" sayısını Sırpçaya çevir', promptEn: 'Translate the number "7" to Serbian', streetPrompt: 'Yedi — u srpskom?', answer: 'Sedam', hint: 'se-dam', hintEn: 'se-dam' },
          { id: 'n1-q11', type: 'multiple-choice', prompt: '"Pet" hangi sayıdır?', promptEn: 'Which number is "Pet"?', streetPrompt: 'Kapiram — "Pet" kaç?', answer: '5', answerEn: '5', options: ['3', '4', '5', '6'], optionsEn: ['3', '4', '5', '6'] },
          { id: 'n1-q12', type: 'fill-blank', prompt: 'Sırpçada "bir" kelimesi "___" dir.', promptEn: 'The word for "one" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 1 = ?', answer: 'Jedan', answerEn: 'Jedan', hint: 'Je-dan', hintEn: 'Je-dan' },
          { id: 'n1-q13', type: 'translate', prompt: '"3" sayısını Sırpçaya çevir', promptEn: 'Translate the number "3" to Serbian', streetPrompt: 'Üç — u srpskom?', answer: 'Tri', hint: 'tri', hintEn: 'tri' },
          { id: 'n1-q14', type: 'multiple-choice', prompt: '"Osam" kaç eder?', promptEn: 'What number is "Osam"?', streetPrompt: '"Osam" — hangi sayı brate?', answer: '8', answerEn: '8', options: ['6', '7', '8', '9'], optionsEn: ['6', '7', '8', '9'] },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'n2-q7', type: 'fill-blank', prompt: 'Sırpçada "yirmi" kelimesi "___" dir.', promptEn: 'The word for "twenty" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 20 = ?', answer: 'Dvadeset', answerEn: 'Dvadeset', hint: 'dva = iki + deset = on', hintEn: 'dva = two + deset = ten' },
          { id: 'n2-q8', type: 'multiple-choice', prompt: '"Sedamdeset" kaçtır?', promptEn: 'What number is "Sedamdeset"?', streetPrompt: '"Sedamdeset" — kaç brate?', answer: '70', answerEn: '70', options: ['60', '70', '80', '90'], optionsEn: ['60', '70', '80', '90'] },
          { id: 'n2-q9', type: 'translate', prompt: '"500" sayısını Sırpçaya çevir', promptEn: 'Translate the number "500" to Serbian', streetPrompt: 'Beş yüz — u srpskom?', answer: 'Petsto', hint: 'pet = beş + sto = yüz', hintEn: 'pet = five + sto = hundred' },
          { id: 'n2-q10', type: 'fill-blank', prompt: 'Sırpçada "otuz" kelimesi "___" dir.', promptEn: 'The word for "thirty" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 30 = ?', answer: 'Trideset', answerEn: 'Trideset', hint: 'tri = üç + deset', hintEn: 'tri = three + deset = ten' },
          { id: 'n2-q11', type: 'multiple-choice', prompt: '"200" Sırpçada nasıl denir?', promptEn: 'How do you say "200" in Serbian?', streetPrompt: 'İki yüz — u srpskom?', answer: 'Dvesta', answerEn: 'Dvesta', options: ['Dvadeset', 'Dvesta', 'Dvanaest', 'Dve hiljade'], optionsEn: ['Dvadeset', 'Dvesta', 'Dvanaest', 'Dve hiljade'] },
        ],
      },
      {
        id: 'numbers-2b', title: 'Sayılar: Boşluk Doldur', titleEn: 'Numbers: Fill in the Blanks', streetTitle: 'Test brate!', emoji: '🔢', xpReward: 100,
        questions: [
          { id: 'n2b-q1', type: 'fill-blank', prompt: 'Sırpçada "yüz" kelimesi "___" dir.', promptEn: 'The word for "hundred" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 100 = ?', answer: 'Sto', answerEn: 'Sto', hint: 'çok kısa — 3 harf!', hintEn: 'very short — 3 letters!' },
          { id: 'n2b-q2', type: 'fill-blank', prompt: 'Sırpçada "elli" kelimesi "___" dir.', promptEn: 'The word for "fifty" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 50 = ?', answer: 'Pedeset', answerEn: 'Pedeset', hint: 'pe-de-set', hintEn: 'pe-de-set' },
          { id: 'n2b-q3', type: 'fill-blank', prompt: 'Sırpçada "bin" kelimesi "___" dir.', promptEn: 'The word for "thousand" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 1000 = ?', answer: 'Hiljada', answerEn: 'Hiljada', hint: 'hil-ja-da', hintEn: 'hil-ya-da' },
          { id: 'n2b-q4', type: 'translate', prompt: '"40" sayısını Sırpçaya çevir', promptEn: 'Translate the number "40" to Serbian', streetPrompt: 'Kırk — u srpskom?', answer: 'Četrdeset', hint: 'dört ile başlar', hintEn: 'starts like four (Četiri)' },
          { id: 'n2b-q5', type: 'multiple-choice', prompt: '"Dvanaest" hangi sayıdır?', promptEn: 'Which number is "Dvanaest"?', streetPrompt: 'Pazi — "Dvanaest" kaç?', answer: '12', answerEn: '12', options: ['11', '12', '20', '22'], optionsEn: ['11', '12', '20', '22'] },
          { id: 'n2b-q6', type: 'multiple-choice', prompt: '"60" nasıl denir?', promptEn: 'How do you say "60"?', streetPrompt: 'Altmış — u srpskom?', answer: 'Šezdeset', answerEn: 'Šezdeset', options: ['Pedeset', 'Šezdeset', 'Sedamdeset', 'Osamdeset'], optionsEn: ['Pedeset', 'Šezdeset', 'Sedamdeset', 'Osamdeset'] },
          { id: 'n2b-q7', type: 'fill-blank', prompt: '"Dvadeset" Türkçede "___" demektir.', promptEn: '"Dvadeset" in English means "___".', streetPrompt: 'Boşluğu doldur: Dvadeset = ?', answer: '20', answerEn: '20', hint: 'iki onluk', hintEn: 'two tens' },
          { id: 'n2b-q8', type: 'multiple-choice', prompt: '"90" nasıl denir?', promptEn: 'How do you say "90"?', streetPrompt: 'Doksan — u srpskom?', answer: 'Devedeset', answerEn: 'Devedeset', options: ['Sedamdeset', 'Osamdeset', 'Devedeset', 'Deset'], optionsEn: ['Sedamdeset', 'Osamdeset', 'Devedeset', 'Deset'] },
          { id: 'n2b-q9', type: 'fill-blank', prompt: '"Trinaest" Türkçede "___" demektir.', promptEn: '"Trinaest" in English means "___".', streetPrompt: 'Boşluğu doldur: Trinaest = ?', answer: '13', answerEn: '13', hint: 'tri = üç + naest = on üstü', hintEn: 'tri = three + naest = teen' },
          { id: 'n2b-q10', type: 'translate', prompt: '"80" sayısını Sırpçaya çevir', promptEn: 'Translate the number "80" to Serbian', streetPrompt: 'Seksen — u srpskom?', answer: 'Osamdeset', hint: 'osam = sekiz + deset', hintEn: 'osam = eight + deset = ten' },
          { id: 'n2b-q11', type: 'multiple-choice', prompt: '"Petnaest" hangi sayıdır?', promptEn: 'Which number is "Petnaest"?', streetPrompt: '"Petnaest" — kaç?', answer: '15', answerEn: '15', options: ['5', '12', '15', '50'], optionsEn: ['5', '12', '15', '50'] },
          { id: 'n2b-q12', type: 'fill-blank', prompt: 'Sırpçada "kırk" kelimesi "___" dir.', promptEn: 'The word for "forty" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: 40 = ?', answer: 'Četrdeset', answerEn: 'Četrdeset', hint: 'Che-tr-de-set', hintEn: 'Che-tr-de-set' },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'n3-q6', type: 'fill-blank', prompt: '"Saat kaç?" sorusu Sırpçada "Koliko je ___?" şeklindedir.', promptEn: '"What time is it?" in Serbian is "Koliko je ___?"', streetPrompt: 'Boşluğu doldur: Koliko je ___?', answer: 'sati', answerEn: 'sati', hint: 'sat = saat; sati = saatin (çoğul)', hintEn: 'sat = clock; sati = of clock' },
          { id: 'n3-q7', type: 'multiple-choice', prompt: '"Jutro" ne anlama gelir?', promptEn: 'What does "Jutro" mean?', streetPrompt: '"Jutro" — šta je to?', answer: 'Sabah', answerEn: 'Morning', options: ['Akşam', 'Öğlen', 'Sabah', 'Gece'], optionsEn: ['Evening', 'Noon', 'Morning', 'Night'] },
          { id: 'n3-q8', type: 'fill-blank', prompt: '"Gece yarısı" Sırpçada "Ponoć" veya "___ noći" denir.', promptEn: '"Midnight" in Serbian is "Ponoć" or "___ noći".', streetPrompt: 'Boşluğu doldur: ___ noći', answer: 'Pola', answerEn: 'Pola', hint: 'pola = yarı', hintEn: 'pola = half' },
          { id: 'n3-q9', type: 'multiple-choice', prompt: '"Veče" ne anlama gelir?', promptEn: 'What does "Veče" mean?', streetPrompt: '"Veče" — šta je to?', answer: 'Akşam', answerEn: 'Evening', options: ['Sabah', 'Öğlen', 'Akşam', 'Gece yarısı'], optionsEn: ['Morning', 'Noon', 'Evening', 'Midnight'] },
          { id: 'n3-q10', type: 'translate', prompt: '"Saat 5" cümlesini çevir', promptEn: 'Translate the phrase "It is 5 o\'clock"', streetPrompt: 'Pet sati — çevir bunu!', answer: 'Pet sati', hint: 'pet = beş, sati = saat', hintEn: 'pet = five, sati = clock/hour' },
          { id: 'n3-q11', type: 'multiple-choice', prompt: '"Sekund" ne anlama gelir?', promptEn: 'What does "Sekund" mean?', streetPrompt: '"Sekund" — šta je to brate?', answer: 'Saniye', answerEn: 'Second', options: ['Dakika', 'Saat', 'Saniye', 'Gün'], optionsEn: ['Minute', 'Hour', 'Second', 'Day'] },
          { id: 'n3-q12', type: 'fill-blank', prompt: 'Sırpçada "saat" kelimesi "___" dir.', promptEn: 'The word for "hour/clock" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: saat = ?', answer: 'Sat', answerEn: 'Sat', hint: 'S-a-t', hintEn: 'S-a-t' },
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'f1-q7', type: 'fill-blank', prompt: 'Sırpçada su "___" dır.', promptEn: 'Water in Serbian is "___".', streetPrompt: 'Boşluğu doldur: su = ?', answer: 'Voda', answerEn: 'Voda', hint: 'V ile başlar', hintEn: 'Starts with V' },
          { id: 'f1-q8', type: 'fill-blank', prompt: 'Hesap isterken "___, molim" deriz.', promptEn: 'When asking for the bill we say "___, molim".', streetPrompt: 'Boşluğu doldur: hesap = ?', answer: 'Račun', answerEn: 'Račun', hint: 'ra-čun', hintEn: 'ra-chun' },
          { id: 'f1-q9', type: 'multiple-choice', prompt: '"Žedan sam" ne anlama gelir?', promptEn: 'What does "Žedan sam" mean?', streetPrompt: 'Brate — "Žedan sam" ne diyor?', answer: 'Susadım', answerEn: 'I am thirsty', options: ['Açım', 'Susadım', 'Doydum', 'Yorgunum'], optionsEn: ['I am hungry', 'I am thirsty', 'I am full', 'I am tired'] },
          { id: 'f1-q10', type: 'translate', prompt: '"Çay" kelimesini çevir', promptEn: 'Translate the word "Tea"', streetPrompt: 'Çay mı, kahve mi? "Çay" u srpskom?', answer: 'Čaj', hint: 'ç ile başlar!', hintEn: 'starts with ch!' },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'f2-q7', type: 'fill-blank', prompt: 'Sırpçada ekmek "___" dir.', promptEn: 'Bread in Serbian is "___".', streetPrompt: 'Boşluğu doldur: ekmek = ?', answer: 'Hleb', answerEn: 'Hleb', hint: 'H ile başlar', hintEn: 'Starts with H' },
          { id: 'f2-q8', type: 'fill-blank', prompt: 'Yemek lezzetli olduğunda "___" deriz.', promptEn: 'When food is tasty, we say "___".', streetPrompt: 'Boşluğu doldur: lezzetli = ?', answer: 'Ukusno', answerEn: 'Ukusno', hint: 'u-kus-no', hintEn: 'u-kus-no' },
          { id: 'f2-q9', type: 'multiple-choice', prompt: '"Doručak" ne anlama gelir?', promptEn: 'What does "Doručak" mean?', streetPrompt: 'Sabah kahvaltı — Sırpçada?', answer: 'Kahvaltı', answerEn: 'Breakfast', options: ['Öğle yemeği', 'Akşam yemeği', 'Kahvaltı', 'Atıştırmalık'], optionsEn: ['Lunch', 'Dinner', 'Breakfast', 'Snack'] },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'f3-q6', type: 'fill-blank', prompt: 'Sırpçada elma "___" dır.', promptEn: 'Apple in Serbian is "___".', streetPrompt: 'Boşluğu doldur: elma = ?', answer: 'Jabuka', answerEn: 'Jabuka', hint: 'ja-bu-ka', hintEn: 'ja-bu-ka' },
          { id: 'f3-q7', type: 'fill-blank', prompt: 'Sırpçada domates "___" dir.', promptEn: 'Tomato in Serbian is "___".', streetPrompt: 'Boşluğu doldur: domates = ?', answer: 'Paradajz', answerEn: 'Paradajz', hint: 'Paradise gibi!', hintEn: 'Sounds like Paradise!' },
          { id: 'f3-q8', type: 'multiple-choice', prompt: '"Jeftino" ne anlama gelir?', promptEn: 'What does "Jeftino" mean?', streetPrompt: 'Bargain — "Jeftino" nedir?', answer: 'Ucuz', answerEn: 'Cheap', options: ['Pahalı', 'Ucuz', 'Ücretsiz', 'Ortalama'], optionsEn: ['Expensive', 'Cheap', 'Free', 'Average'] },
          { id: 'f3-q9', type: 'translate', prompt: '"Biber" kelimesini çevir', promptEn: 'Translate the word "Pepper"', streetPrompt: 'Pijacada biber — Sırpçada?', answer: 'Paprika', hint: 'Türkçeye çok benziyor!', hintEn: 'Very similar to English!' },
        ],
      },
    ],
  },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          { id: 'd1-q6', type: 'fill-blank', prompt: 'Sırpçada "sol" yön "___" dır.', promptEn: 'The direction "left" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: sol = ?', answer: 'Levo', answerEn: 'Levo', hint: 'L ile başlar', hintEn: 'Starts with L' },
          { id: 'd1-q7', type: 'fill-blank', prompt: 'Sırpçada "sağ" yön "___" dir.', promptEn: 'The direction "right" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: sağ = ?', answer: 'Desno', answerEn: 'Desno', hint: 'D ile başlar', hintEn: 'Starts with D' },
          { id: 'd1-q8', type: 'multiple-choice', prompt: '"Dole" ne anlama gelir?', promptEn: 'What does "Dole" mean?', streetPrompt: 'Yön — "Dole" nereyi gösteriyor?', answer: 'Aşağı', answerEn: 'Down', options: ['Yukarı', 'Aşağı', 'Sağ', 'Sol'], optionsEn: ['Up', 'Down', 'Right', 'Left'] },
          { id: 'd1-q9', type: 'translate', prompt: '"Yakın" kelimesini çevir', promptEn: 'Translate the word "Close / Near"', streetPrompt: 'Brate, yakın mesafeyi nasıl söylersin?', answer: 'Blizu', hint: 'bli-zu', hintEn: 'bli-zu' },
          { id: 'd1-q10', type: 'multiple-choice', prompt: '"Gore" ne anlama gelir?', promptEn: 'What does "Gore" mean?', streetPrompt: '"Gore" — nereye brate?', answer: 'Yukarı', answerEn: 'Up', options: ['Aşağı', 'Yukarı', 'İleri', 'Geri'], optionsEn: ['Down', 'Up', 'Forward', 'Back'] },
          { id: 'd1-q11', type: 'fill-blank', prompt: '"Dümdüz git" demek için Sırpçada "Idi ___" deriz.', promptEn: 'To say "Go straight" in Serbian we say "Idi ___".', streetPrompt: 'Boşluğu doldur: Idi ___', answer: 'pravo', answerEn: 'pravo', hint: 'pravo = düz/doğru', hintEn: 'pravo = straight/directly' },
          { id: 'd1-q12', type: 'multiple-choice', prompt: '"Gde je?" ne anlama gelir?', promptEn: 'What does "Gde je?" mean?', streetPrompt: '"Gde je?" — šta pita?', answer: 'Nerede?', answerEn: 'Where is it?', options: ['Ne zaman?', 'Neden?', 'Nerede?', 'Nasıl?'], optionsEn: ['When?', 'Why?', 'Where is it?', 'How?'] },
        ],
      },
      {
        ...
        questions: [
          ...
          { id: 'd2-q6', type: 'fill-blank', prompt: 'Sırpçada havalimanı "___" dır.', promptEn: 'Airport in Serbian is "___".', streetPrompt: 'Boşluğu doldur: havalimanı = ?', answer: 'Aerodrom', answerEn: 'Aerodrom', hint: 'Aero + drom', hintEn: 'Aero + drom' },
          { id: 'd2-q7', type: 'fill-blank', prompt: 'Sırpçada bilet "___" dir.', promptEn: 'Ticket in Serbian is "___".', streetPrompt: 'Boşluğu doldur: bilet = ?', answer: 'Karta', answerEn: 'Karta', hint: 'kar-ta', hintEn: 'kar-ta' },
          { id: 'd2-q8', type: 'multiple-choice', prompt: '"Tramvaj" ne demektir?', promptEn: 'What is "Tramvaj"?', streetPrompt: 'Beograd\'da ne biniyorsun?', answer: 'Tramvay', answerEn: 'Tram', options: ['Otobüs', 'Taksi', 'Tramvay', 'Metro'], optionsEn: ['Bus', 'Taxi', 'Tram', 'Metro'] },
          { id: 'd2-q9', type: 'translate', prompt: '"Hangi otobüs merkeze gidiyor?" cümlesini çevir', promptEn: 'Translate "Which bus goes to the center?"', streetPrompt: 'Brate, doğru otobüsü nasıl bulursun?', answer: 'Koji autobus ide u centar?', hint: 'koji = hangi, ide = gidiyor', hintEn: 'koji = which, ide = goes' },
          { id: 'd2-q10', type: 'multiple-choice', prompt: '"Voz" nedir?', promptEn: 'What is "Voz"?', streetPrompt: '"Voz" — šta je to?', answer: 'Tren', answerEn: 'Train', options: ['Otobüs', 'Tren', 'Taksi', 'Gemi'], optionsEn: ['Bus', 'Train', 'Taxi', 'Ship'] },
          { id: 'd2-q11', type: 'fill-blank', prompt: '"Otobüs" Sırpçada "___" dur.', promptEn: '"Bus" in Serbian is "___".', streetPrompt: 'Boşluğu doldur: otobüs = ?', answer: 'Autobus', answerEn: 'Autobus', hint: 'auto + bus', hintEn: 'auto + bus' },
          { id: 'd2-q12', type: 'translate', prompt: '"Otel nerede?" cümlesini çevir', promptEn: 'Translate "Where is the hotel?"', streetPrompt: 'Beograd\'da oteli nasıl sorarsın?', answer: 'Gde je hotel?', hint: 'Gde = nerede, je = -dir', hintEn: 'Gde = where, je = is' },
        ],
      },
    ],
  },
