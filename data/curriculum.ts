    ...
    lessons: [
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 's2-q4', type: 'multiple-choice', prompt: '"Mrak" kelime anlamında karanlıktır, argoda nedir?', promptEn: 'What does "Mrak" mean in slang?', streetPrompt: 'Brate — "Mrak" — šta je to?', answer: 'Karanlık, ama argoda "Harika/Efsane"', answerEn: 'Darkness, but in slang "Great/Epic"', options: ['Berbat','Karanlık, ama argoda "Harika/Efsane"','Sıkıcı','Soğuk'], optionsEn: ['Terrible','Darkness, but in slang "Great/Epic"','Boring','Cold'] },
          { id: 's2-q5', type: 'multiple-choice', prompt: '"Sve pet" ne anlama gelir?', promptEn: 'What does "Sve pet" mean?', streetPrompt: 'Brate — "Sve pet" — šta znači?', answer: 'Her şey on numara beş yıldız', answerEn: 'Everything is great', options: ['Beş kişi','Her şey on numara beş yıldız','Çak bi beşlik','Beş liram var'], optionsEn: ['Five people','Everything is great','High five','I have five liras'] },
      ...
      },
      {
        ...
        questions: [
          ...
          { id: 's3-q2', type: 'multiple-choice', prompt: '"Idi" ne anlama gelir?', promptEn: 'What does "Idi" mean?', streetPrompt: 'Biri sana "Idi!" diye bağırıyor, ne istiyor?', answer: 'Çek git / Kaybol!', answerEn: 'Go away / Get lost!', options: ['Buraya gel!','Çek git / Kaybol!','Otur ulan!','Dur!'], optionsEn: ['Come here!','Go away / Get lost!','Sit down!','Stop!'] },
      ...
      },
      {
        ...
        questions: [
          { id: 's4-q1', type: 'multiple-choice', prompt: '"Smuvati" ne anlama gelir?', promptEn: 'What does "Smuvati" mean?', streetPrompt: 'Pazi brate — šta znači "smuvati"?', answer: 'Tavlamak / Biriyle başarılı flörtleşmek', answerEn: 'To hit on someone / To successfully flirt', options: ['Kavga etmek','Kaçmak','Tavlamak / Biriyle başarılı flörtleşmek','Sarhoş olmak'], optionsEn: ['To fight','To run away','To hit on someone / To successfully flirt','To get drunk'] },
