    ...
    <div style={{ maxWidth: 560, margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: 36 }}>
        ...
        <p style={{ color: '#666', marginTop: 10, fontSize: '0.9rem' }}>
          {streetMode ? 'Za prave likove koji hoće više, brate.' : 'For serious learners. No more holding back.'}
        </p>
      </div>
      ...
      {isPro ? (
        <div className="glass-strong" style={{ padding: 32, textAlign: 'center' }}>
          <div style={{ fontSize: '3rem', marginBottom: 12 }}>🎉</div>
          <h2 style={{ fontWeight: 900, fontFamily: 'Space Grotesk, sans-serif', marginBottom: 8 }}>You are Pro!</h2>
          <p style={{ color: '#888' }}>Kapiram — you have full access, brate. Keep learning!</p>
        ...
        <>
          ...
          <div style={{ background: 'linear-gradient(135deg, rgba(192,57,43,0.12), rgba(0,61,165,0.08))', border: '2px solid rgba(192,57,43,0.3)', borderRadius: 20, padding: 32, marginBottom: 24, position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', top: 16, right: 16, background: '#c0392b', color: '#fff', fontSize: '0.7rem', fontWeight: 800, padding: '4px 10px', borderRadius: 20, letterSpacing: '0.1em' }}>MOST POPULAR</div>
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontSize: '2.5rem', fontWeight: 900, fontFamily: 'Space Grotesk, sans-serif', color: '#f5f5f5' }}>€12.00<span style={{ fontSize: '1rem', color: '#666', fontWeight: 400 }}>/month</span></div>
              <div style={{ color: '#ff4757', fontWeight: 600, fontSize: '0.85rem', marginTop: 4 }}>Şuan alımlar kapalı, en yakın zamanda açılacaktır!</div>
            </div>
            ...
            <button id="stripe-checkout-btn" onClick={handleCheckout} disabled={true} className="btn-primary" style={{ width: '100%', fontSize: '1.05rem', padding: '16px 28px', opacity: 0.5, cursor: 'not-allowed' }}>
              SATIN ALIMLAR KAPALI 🔒
            </button>
          </div>

          {/* Free tier comparison */}
          <div className="card">
            <h3 style={{ fontWeight: 800, fontFamily: 'Space Grotesk, sans-serif', marginBottom: 14, fontSize: '0.9rem', color: '#888' }}>Free plan includes:</h3>
